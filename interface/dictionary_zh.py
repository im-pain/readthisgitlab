translation_dictionary = {
    ...
    'separate_clothes'      : '分类类型',
    'separate_clothes_A'    : "单一服装",
    'separate_clothes_A_tt' : "导入所有内容并获得包含所有衣服模型的单个对象。默认情况下隐藏任何备用衣服",
    'separate_clothes_B'    : "分开所有对象",
    'separate_clothes_B_tt' : "导入所有内容并自动将每件衣服分成多个对象",
    ...
    'prep_drop_A_tt'    : """编辑骨骼层级以允许Unity自动检测正确骨骼""",
    ...
    'prep_drop_E'       : '虚幻引擎',
    'prep_drop_E_tt'    : """编辑骨骼层级以允许Unity自动检测正确骨骼""",
