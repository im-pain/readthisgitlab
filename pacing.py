...
bone_hon = arm.pose.bones.get("cf_J_Hips")
bone_koi = arm.pose.bones.get("cf_j_hips")
...
def the_script(skeleton_model, parameters):
    ...
    if bone_koi:
    #if "cf_j_hips" in arm.pose.bones:
        head = "cf_j_head"
        ...
        if bone_hon:
            ...
            clav_r = "cf_J_Shoulder_R"
            clav_l = "cf_J_Shoulder_L"
            uparm_l = "cf_J_ArmUp00_L"
            uparm_r = "cf_J_ArmUp00_R"
            lowarm_l = "cf_J_ArmLow01_L"
            lowarm_r = "cf_J_ArmLow01_R"
            hand_l = "cf_J_Hand_L"
            hand_r = "cf_J_Hand_R"

            palm_pinky_r = ""
            pinky_01_r = "cf_J_Hand_Little01_R"
            pinky_02_r = "cf_J_Hand_Little02_R"
            pinky_03_r = "cf_J_Hand_Little03_R"
            palm_ring_r = ""
            ring_01_r = "cf_J_Hand_Ring01_R"
            ring_02_r = "cf_J_Hand_Ring02_R"
            ring_03_r = "cf_J_Hand_Ring03_R"
            palm_middle_r = ""
            middle_01_r = "cf_J_Hand_Middle01_R"
            middle_02_r = "cf_J_Hand_Middle02_R"
            middle_03_r = "cf_J_Hand_Middle03_R"
            palm_index_r = ""
            index_01_r = "cf_J_Hand_Index01_R"
            index_02_r = "cf_J_Hand_Index02_R"
            index_03_r = "cf_J_Hand_Index03_R"
            thumb_01_r = "cf_J_Hand_Thumb01_R"
            thumb_02_r = "cf_J_Hand_Thumb02_R"
            thumb_03_r = "cf_J_Hand_Thumb03_R"
            palm_pinky_l = ""
            pinky_01_l = "cf_J_Hand_Little01_L"
            pinky_02_l = "cf_J_Hand_Little02_L"
            pinky_03_l = "cf_J_Hand_Little03_L"
            palm_ring_l = ""
            ring_01_l = "cf_J_Hand_Ring01_L"
            ring_02_l = "cf_J_Hand_Ring02_L"
            ring_03_l = "cf_J_Hand_Ring03_L"
            palm_middle_l = ""
            middle_01_l = "cf_J_Hand_Middle01_L"
            middle_02_l = "cf_J_Hand_Middle02_L"
            middle_03_l = "cf_J_Hand_Middle03_L"
            palm_index_l = ""
            index_01_l = "cf_J_Hand_Index01_L"
            index_02_l = "cf_J_Hand_Index02_L"
            index_03_l = "cf_J_Hand_Index03_L"
            thumb_01_l = "cf_J_Hand_Thumb01_L"
            thumb_02_l = "cf_J_Hand_Thumb02_L"
            thumb_03_l = "cf_J_Hand_Thumb03_L"

            thigh_l = "cf_J_LegUp00_L"
            thigh_r = "cf_J_LegUp00_R"
            calf_l = "cf_J_LegLow01_L"
            calf_r = "cf_J_LegLow01_R"
            foot_l = "cf_J_Foot02_L"
            foot_r = "cf_J_Foot02_R"
            toe_l = "cf_J_Toes01_L"
            toe_r = "cf_J_Toes01_R"
            heel_l = ""
            heel_r = ""
...
if bone_hon:
    bone_lib_game = bone_hon
    bone_name_game = bone_hon.name
elif bone_koi:
    bone_lib_game = bone_koi
    bone_name_game = bone_koi.name

if "Copy Rotation" in arm.pose.bones[bone_name_game].constraints:
    if arm.pose.bones.constraints["Copy Rotation"].enabled is True:
        toggle_rigi = False
    else:
        toggle_rigi = True

    for g_bone in arm.pose.bones:
        for cstr in arm.pose.bones[g_bone.name].constraints:
            if "Copy Location" in cstr.name:
                arm.pose.bones[g_bone.name].constraints[cstr.name].enabled = toggle_rigi
    ...
    if bone_koi:
        #CODOS
        arma_2.pose.bones['cf_s_elboback_L'].select = True
        ...
        arma_2.pose.bones['cf_s_elboback_R'].select = True
        ...
        bpy.ops.pose.select_all(action='DESELECT')
        #RODILLAS
        arma_2.pose.bones['cf_s_leg01_L'].select = True
        ...
        arma_2.pose.bones['cf_s_leg01_R'].select = True
        ...
        bpy.ops.pose.select_all(action='DESELECT')
        #PIERNA
        arma_2.pose.bones['cf_s_kneeB_L'].select = True
        ...
        arma_2.pose.bones['cf_s_kneeB_R'].select = True
        ...
        bpy.ops.pose.select_all(action='DESELECT')
        #WAIST
        arma_2.pose.bones['cf_s_leg_L'].select = True
        ...
        arma_2.pose.bones['cf_s_leg_R'].select = True
        ...
        arms_L = ('cf_J_ArmElbo_dam_01_L','cf_J_ArmElboura_dam_L')
        arms_R = ('cf_J_ArmElbo_dam_01_R','cf_J_ArmElboura_dam_R')
        
        for fox in arms_L:
            arma_2.pose.bones[fox].select = True
            bpy.context.object.data.bones.active = arma_2.pose.bones[fox].bone

            bpy.ops.pose.constraint_add(type='COPY_ROTATION')
            arma_2.pose.bones[fox].constraints['Copy Rotation'].target = arma_rig
            arma_2.pose.bones[fox].constraints['Copy Rotation'].subtarget = 'DEF-cf_J_ArmLow01_L'
            arma_2.pose.bones[fox].constraints['Copy Rotation'].use_x = 0
            arma_2.pose.bones[fox].constraints['Copy Rotation'].use_y = 1
            arma_2.pose.bones[fox].constraints['Copy Rotation'].use_z = 0
            arma_2.pose.bones[fox].constraints["Copy Rotation"].target_space = 'LOCAL_OWNER_ORIENT'
            arma_2.pose.bones[fox].constraints["Copy Rotation"].owner_space = 'LOCAL'
            bpy.ops.pose.select_all(action='DESELECT')

        arma_2.pose.bones['cf_J_ArmElboura_dam_L'].constraints['Copy Rotation'].influence = 0.5

        for fok in arms_R:
            arma_2.pose.bones[fok].select = True
            bpy.context.object.data.bones.active = arma_2.pose.bones[fok].bone

            bpy.ops.pose.constraint_add(type='COPY_ROTATION')
            arma_2.pose.bones[fok].constraints['Copy Rotation'].target = arma_rig
            arma_2.pose.bones[fok].constraints['Copy Rotation'].subtarget = 'DEF-cf_J_ArmLow01_R'
            arma_2.pose.bones[fok].constraints['Copy Rotation'].use_x = 0
            arma_2.pose.bones[fok].constraints['Copy Rotation'].use_y = 1
            arma_2.pose.bones[fok].constraints['Copy Rotation'].use_z = 0
            arma_2.pose.bones[fok].constraints["Copy Rotation"].target_space = 'LOCAL_OWNER_ORIENT'
            arma_2.pose.bones[fok].constraints["Copy Rotation"].owner_space = 'LOCAL'
            bpy.ops.pose.select_all(action='DESELECT')

        arma_2.pose.bones['cf_J_ArmElboura_dam_R'].constraints['Copy Rotation'].influence = 0.5

        legs_L = ('cf_J_LegKnee_back_L','cf_J_LegKnee_dam_L')
        legs_R = ('cf_J_LegKnee_back_R','cf_J_LegKnee_dam_R')

        for lox in legs_L:
            arma_2.pose.bones[lox].select = True
            bpy.context.object.data.bones.active = arma_2.pose.bones[lox].bone

            bpy.ops.pose.constraint_add(type='COPY_ROTATION')
            arma_2.pose.bones[lox].constraints['Copy Rotation'].target = arma_rig
            arma_2.pose.bones[lox].constraints['Copy Rotation'].subtarget = 'DEF-cf_J_LegLow01_L'
            arma_2.pose.bones[lox].constraints['Copy Rotation'].use_x = 1
            arma_2.pose.bones[lox].constraints['Copy Rotation'].use_y = 0
            arma_2.pose.bones[lox].constraints['Copy Rotation'].use_z = 0
            arma_2.pose.bones[lox].constraints["Copy Rotation"].target_space = 'LOCAL_OWNER_ORIENT'
            arma_2.pose.bones[lox].constraints["Copy Rotation"].owner_space = 'LOCAL'
            bpy.ops.pose.select_all(action='DESELECT')

        arma_2.pose.bones['cf_J_LegKnee_dam_L'].constraints['Copy Rotation'].influence = 0.5

        for lok in legs_R:
            arma_2.pose.bones[lok].select = True
            bpy.context.object.data.bones.active = arma_2.pose.bones[lok].bone

            bpy.ops.pose.constraint_add(type='COPY_ROTATION')
            arma_2.pose.bones[lok].constraints['Copy Rotation'].target = arma_rig
            arma_2.pose.bones[lok].constraints['Copy Rotation'].subtarget = 'DEF-cf_J_LegLow01_R'
            arma_2.pose.bones[lok].constraints['Copy Rotation'].use_x = 1
            arma_2.pose.bones[lok].constraints['Copy Rotation'].use_y = 0
            arma_2.pose.bones[lok].constraints['Copy Rotation'].use_z = 0
            arma_2.pose.bones[lok].constraints["Copy Rotation"].target_space = 'LOCAL_OWNER_ORIENT'
            arma_2.pose.bones[lok].constraints["Copy Rotation"].owner_space = 'LOCAL'
            bpy.ops.pose.select_all(action='DESELECT')

        arma_2.pose.bones['cf_J_LegKnee_dam_R'].constraints['Copy Rotation'].influence = 0.5

        waists_L = ('cf_J_LegUpDam_L','cf_J_SiriDam_L','cf_J_SiriDam01_L','cf_J_Siri_s_L','cf_J_Siri_L')
        waists_R = ('cf_J_LegUpDam_R','cf_J_SiriDam_R','cf_J_SiriDam01_R','cf_J_Siri_s_R','cf_J_Siri_R')

        for wail in waists_L:
            arma_2.pose.bones[wail].select = True
            bpy.context.object.data.bones.active = arma_2.pose.bones[wail].bone

            bpy.ops.pose.constraint_add(type='COPY_ROTATION')
            arma_2.pose.bones[wail].constraints['Copy Rotation'].target = arma_rig
            arma_2.pose.bones[wail].constraints['Copy Rotation'].subtarget = 'DEF-cf_J_LegUp00_L'
            arma_2.pose.bones[wail].constraints['Copy Rotation'].use_x = 1
            arma_2.pose.bones[wail].constraints['Copy Rotation'].use_y = 0
            arma_2.pose.bones[wail].constraints['Copy Rotation'].use_z = 0
            arma_2.pose.bones[wail].constraints["Copy Rotation"].target_space = 'LOCAL_OWNER_ORIENT'
            arma_2.pose.bones[wail].constraints["Copy Rotation"].owner_space = 'LOCAL'
            bpy.ops.pose.select_all(action='DESELECT')
            
        arma_2.pose.bones['cf_J_SiriDam_L'].constraints['Copy Rotation'].influence = 0.8
        arma_2.pose.bones['cf_J_Siri_L'].constraints['Copy Rotation'].influence = 0.5
        arma_2.pose.bones['cf_J_SiriDam01_L'].constraints['Copy Rotation'].invert_x = 1

        for wair in waists_R:
            arma_2.pose.bones[wair].select = True
            bpy.context.object.data.bones.active = arma_2.pose.bones[wair].bone

            bpy.ops.pose.constraint_add(type='COPY_ROTATION')
            arma_2.pose.bones[wair].constraints['Copy Rotation'].target = arma_rig
            arma_2.pose.bones[wair].constraints['Copy Rotation'].subtarget = 'DEF-cf_J_LegUp00_R'
            arma_2.pose.bones[wair].constraints['Copy Rotation'].use_x = 1
            arma_2.pose.bones[wair].constraints['Copy Rotation'].use_y = 0
            arma_2.pose.bones[wair].constraints['Copy Rotation'].use_z = 0
            arma_2.pose.bones[wair].constraints["Copy Rotation"].target_space = 'LOCAL_OWNER_ORIENT'
            arma_2.pose.bones[wair].constraints["Copy Rotation"].owner_space = 'LOCAL'
            bpy.ops.pose.select_all(action='DESELECT')
            
        arma_2.pose.bones['cf_J_SiriDam_R'].constraints['Copy Rotation'].influence = 0.8
        arma_2.pose.bones['cf_J_Siri_R'].constraints['Copy Rotation'].influence = 0.5
        arma_2.pose.bones['cf_J_SiriDam01_R'].constraints['Copy Rotation'].invert_x = 1
