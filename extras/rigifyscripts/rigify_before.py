...
def main():
    ...
    if metarig.data.bones.get('cf_s_siri_R'):
        metarig.data.bones['cf_s_siri_R'].use_deform = True
        metarig.data.bones['cf_s_siri_L'].use_deform = True
    ...
    #move the IK bone collections above the FK collections in the bone collection list or the UI will look weird
    for collection in [
        koikatsuCommons.leftArmLayerName + koikatsuCommons.ikLayerSuffix,
        koikatsuCommons.rightArmLayerName + koikatsuCommons.ikLayerSuffix,
        koikatsuCommons.leftLegLayerName + koikatsuCommons.ikLayerSuffix,
        koikatsuCommons.rightLegLayerName + koikatsuCommons.ikLayerSuffix,]:
            metarig.data.collections.move(get_rigify_index(collection), 0)

    bpy.ops.armature.rigify_collection_set_ui_row(index = get_rigify_index(koikatsuCommons.koikatsuDeformBonesLayerName), row=0) #remove charamaker bones from UI

    bpy.ops.armature.rigify_collection_set_ui_row(index = get_rigify_index(koikatsuCommons.torsoLayerName), row=1) #move torso
    bpy.ops.armature.rigify_collection_set_ui_row(index = get_rigify_index(koikatsuCommons.torsoLayerName + koikatsuCommons.fkLayerSuffix), row=1) #move torso fk

    bpy.ops.armature.rigify_collection_set_ui_row(index= get_rigify_index(koikatsuCommons.leftArmLayerName + koikatsuCommons.ikLayerSuffix), row=2) #move arm L IK
    bpy.ops.armature.rigify_collection_set_ui_row(index= get_rigify_index(koikatsuCommons.leftArmLayerName + koikatsuCommons.fkLayerSuffix), row=2) #arm L fk
    
    bpy.ops.armature.rigify_collection_set_ui_row(index= get_rigify_index(koikatsuCommons.rightArmLayerName + koikatsuCommons.ikLayerSuffix), row=3) #move arm R IK
    bpy.ops.armature.rigify_collection_set_ui_row(index= get_rigify_index(koikatsuCommons.rightArmLayerName + koikatsuCommons.fkLayerSuffix), row=3) #arm R FK

    bpy.ops.armature.rigify_collection_set_ui_row(index= get_rigify_index(koikatsuCommons.leftLegLayerName + koikatsuCommons.ikLayerSuffix), row=2) #move leg L IK
    bpy.ops.armature.rigify_collection_set_ui_row(index= get_rigify_index(koikatsuCommons.leftLegLayerName + koikatsuCommons.fkLayerSuffix),  row=2) #move leg L FK

    bpy.ops.armature.rigify_collection_set_ui_row(index= get_rigify_index(koikatsuCommons.rightLegLayerName + koikatsuCommons.ikLayerSuffix), row=3) #move leg R IK
    bpy.ops.armature.rigify_collection_set_ui_row(index= get_rigify_index(koikatsuCommons.rightLegLayerName + koikatsuCommons.fkLayerSuffix), row=3) #move leg R FK

    bpy.ops.armature.rigify_collection_set_ui_row(index= get_rigify_index(koikatsuCommons.fingersLayerName), row=6) #fingers
    bpy.ops.armature.rigify_collection_set_ui_row(index = get_rigify_index(koikatsuCommons.faceLayerName), row=6) #move face
    bpy.ops.armature.rigify_collection_set_ui_row(index = get_rigify_index(koikatsuCommons.hairLayerName), row=6) #move hair / accessories

    bpy.ops.armature.rigify_collection_set_ui_row(index = get_rigify_index(koikatsuCommons.torsoLayerName + koikatsuCommons.tweakLayerSuffix), row=7) #move torso tweak
    bpy.ops.armature.rigify_collection_set_ui_row(index= get_rigify_index(koikatsuCommons.fingersLayerName + koikatsuCommons.detailLayerSuffix), row=7) #move fingers detail

    bpy.ops.armature.rigify_collection_set_ui_row(index = get_rigify_index(koikatsuCommons.hairLayerName + koikatsuCommons.detailLayerSuffix), row=8) #move hair detail to same layer
    bpy.ops.armature.rigify_collection_set_ui_row(index = get_rigify_index(koikatsuCommons.hairLayerName + koikatsuCommons.mchLayerSuffix), row=8) #move hair mch to same layer

    bpy.ops.armature.rigify_collection_set_ui_row(index= get_rigify_index(koikatsuCommons.skirtLayerName), row=9) #move skirt
    bpy.ops.armature.rigify_collection_set_ui_row(index= get_rigify_index(koikatsuCommons.skirtLayerName + koikatsuCommons.detailLayerSuffix), row=9) #move skirt detail

    bpy.ops.armature.rigify_collection_set_ui_row(index = get_rigify_index(koikatsuCommons.eyesLayerName), row=10) #move eyes primary
    bpy.ops.armature.rigify_collection_set_ui_row(index = get_rigify_index(koikatsuCommons.faceLayerName + koikatsuCommons.mchLayerSuffix), row=10) #move face mch
